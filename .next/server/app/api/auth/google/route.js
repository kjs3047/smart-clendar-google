...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/auth */ \"(rsc)/./lib/auth.ts\");\n\n\nasync function GET(request) {\n    // Store the frontend's origin from the Referer header to redirect back to it later\n    const referer = request.headers.get('referer');\n    let sessionData = {};\n    if (referer) {\n        try {\n            const refererUrl = new URL(referer);\n            sessionData.frontendOrigin = refererUrl.origin;\n        } catch (e) {\n            console.warn('Could not parse Referer URL:', referer);\n        }\n    }\n    const authorizeUrl = _lib_auth__WEBPACK_IMPORTED_MODULE_1__.oauth2Client.generateAuthUrl({\n        access_type: 'offline',\n        scope: [\n            'https://www.googleapis.com/auth/userinfo.profile',\n            'https://www.googleapis.com/auth/userinfo.email'\n        ],\n        prompt: 'consent'\n    });\n    const response = next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect(authorizeUrl);\n    // Set session cookie\n    response.cookies.set('session', (0,_lib_auth__WEBPACK_IMPORTED_MODULE_1__.createSessionCookie)(sessionData), {\n        maxAge: 30 * 24 * 60 * 60,\n        httpOnly: true,\n        secure: \"development\" === 'production',\n        sameSite: 'lax'\n    });\n    return response;\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/auth/google/route.ts\n");
