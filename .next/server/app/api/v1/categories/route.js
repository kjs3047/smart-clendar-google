...
(() => {
var exports = {};
exports.id = "app/api/v1/categories/route";
exports.ids = ["app/api/v1/categories/route"];
exports.modules = {

/***/ "(rsc)/./app/api/v1/categories/route.ts":
/*!****************************************!*\
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET),\n/* harmony export */   PUT: () => (/* binding */ PUT)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_middleware__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/middleware */ \"(rsc)/./lib/middleware.ts\");\n/* harmony import */ var _lib_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/lib/db */ \"(rsc)/./lib/db.ts\");\n/* harmony import */ var _lib_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/lib/constants */ \"(rsc)/./lib/constants.ts\");\n\n\n\n\nasync function GET(request) {\n    return (0,_lib_middleware__WEBPACK_IMPORTED_MODULE_1__.withAuth)(request, async (req)=>{\n        const categories = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.category.findMany({\n            where: {\n                userId: req.userId\n            },\n            include: {\n                subCategories: true\n            },\n            orderBy: {\n                name: 'asc'\n            }\n        });\n        if (categories.length === 0) {\n            await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.$transaction(_lib_constants__WEBPACK_IMPORTED_MODULE_3__.DEFAULT_CATEGORIES.map((cat)=>_lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.category.create({\n                    data: {\n                        id: cat.id,\n                        name: cat.name,\n                        color: cat.color,\n                        userId: req.userId,\n                        subCategories: {\n                            create: cat.subCategories.map((sub)=>({\n                                    id: sub.id,\n                                    name: sub.name\n                                }))\n                        }\n                    }\n                })));\n            const newCategories = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.category.findMany({\n                where: {\n                    userId: req.userId\n                },\n                include: {\n                    subCategories: true\n                },\n                orderBy: {\n                    name: 'asc'\n                }\n            });\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(newCategories);\n        }\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(categories);\n    });\n}\nasync function PUT(request) {\n    return (0,_lib_middleware__WEBPACK_IMPORTED_MODULE_1__.withAuth)(request, async (req)=>{\n        try {\n            const clientCategories = await request.json();\n            await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.$transaction(async (tx)=>{\n                const existingCatIds = (await tx.category.findMany({\n                    where: {\n                        userId: req.userId\n                    },\n                    select: {\n                        id: true\n                    }\n                })).map((c)=>c.id);\n                const clientCatIds = clientCategories.map((c)=>c.id);\n                const catsToDelete = existingCatIds.filter((id)=>!clientCatIds.includes(id));\n                if (catsToDelete.length > 0) {\n                    await tx.category.deleteMany({\n                        where: {\n                            id: {\n                                in: catsToDelete\n                            },\n                            userId: req.userId\n                        }\n                    });\n                }\n                for (const cat of clientCategories){\n                    const upsertedCategory = await tx.category.upsert({\n                        where: {\n                            id: cat.id\n                        },\n                        update: {\n                            name: cat.name,\n                            color: cat.color\n                        },\n                        create: {\n                            id: cat.id,\n                            name: cat.name,\n                            color: cat.color,\n                            userId: req.userId\n                        }\n                    });\n                    if (cat.subCategories) {\n                        const existingSubCatIds = (await tx.subCategory.findMany({\n                            where: {\n                                categoryId: upsertedCategory.id\n                            },\n                            select: {\n                                id: true\n                            }\n                        })).map((sc)=>sc.id);\n                        const clientSubCatIds = cat.subCategories.map((sc)=>sc.id);\n                        const subCatsToDelete = existingSubCatIds.filter((id)=>!clientSubCatIds.includes(id));\n                        if (subCatsToDelete.length > 0) {\n                            await tx.subCategory.deleteMany({\n                                where: {\n                                    id: {\n                                        in: subCatsToDelete\n                                    }\n                                }\n                            });\n                        }\n                        for (const sub of cat.subCategories){\n                            await tx.subCategory.upsert({\n                                where: {\n                                    id: sub.id\n                                },\n                                update: {\n                                    name: sub.name\n                                },\n                                create: {\n                                    id: sub.id,\n                                    name: sub.name,\n                                    categoryId: upsertedCategory.id\n                                }\n                            });\n                        }\n                    }\n                }\n            });\n            const updatedCategories = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.category.findMany({\n                where: {\n                    userId: req.userId\n                },\n                include: {\n                    subCategories: true\n                }\n            });\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(updatedCategories);\n        } catch (error) {\n            console.error('Error updating categories:', error);\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                message: 'Failed to update categories'\n            }, {\n                status: 500\n            });\n        }\n    });\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/v1/categories/route.ts\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   DEFAULT_CATEGORIES: () => (/* binding */ DEFAULT_CATEGORIES),\n/* harmony export */   MOCK_USER: () => (/* binding */ MOCK_USER),\n/* harmony export */   TASK_STATUS_DISPLAY_NAMES: () => (/* binding */ TASK_STATUS_DISPLAY_NAMES)\n/* harmony export */ });\n/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/types */ \"(rsc)/./types.ts\");\n\nconst DEFAULT_CATEGORIES = [\n    {\n        id: \"cat-1\",\n        name: \"업무\",\n        color: \"#3b82f6\",\n        subCategories: [\n            {\n                id: \"sub-1-1\",\n                name: \"프로젝트 A\"\n            },\n            {\n                id: \"sub-1-2\",\n                name: \"프로젝트 B\"\n            }\n        ]\n    },\n    {\n        id: \"cat-2\",\n        name: \"휴가\",\n        color: \"#16a34a\",\n        subCategories: [\n            {\n                id: \"sub-2-1\",\n                name: \"연차\"\n            },\n            {\n                id: \"sub-2-2\",\n                name: \"반차\"\n            },\n            {\n                id: \"sub-2-3\",\n                name: \"반반차\"\n            }\n        ]\n    },\n    {\n        id: \"cat-3\",\n        name: \"회의\",\n        color: \"#f97316\",\n        subCategories: [\n            {\n                id: \"sub-3-1\",\n                name: \"팀 회의\"\n            },\n            {\n                id: \"sub-3-2\",\n                name: \"클라이언트 미팅\"\n            }\n        ]\n    },\n    {\n        id: \"cat-4\",\n        name: \"출장\",\n        color: \"#9333ea\",\n        subCategories: []\n    },\n    {\n        id: \"cat-5\",\n        name: \"기념일\",\n        color: \"#db2777\",\n        subCategories: [\n            {\n                id: \"sub-5-1\",\n                name: \"생일\"\n            },\n            {\n                id: \"sub-5-2\",\n                name: \"결혼기념일\"\n            }\n        ]\n    },\n    {\n        id: \"cat-6\",\n        name: \"개인\",\n        color: \"#64748b\",\n        subCategories: [\n            {\n                id: \"sub-6-1\",\n                name: \"병원\"\n            },\n            {\n                id: \"sub-6-2\",\n                name: \"운동\"\n            }\n        ]\n    }\n];\nconst MOCK_USER = {\n    name: \"React User\",\n    avatarUrl: \"https://i.pravatar.cc/150?u=a042581f4e29026704d\"\n};\nconst TASK_STATUS_DISPLAY_NAMES = {\n    [_types__WEBPACK_IMPORTED_MODULE_0__.TaskStatus.ToDo]: \"To Do\",\n    [_types__WEBPACK_IMPORTED_MODULE_0__.TaskStatus.InProgress]: \"In Progress\",\n    [_types__WEBPACK_IMPORTED_MODULE_0__.TaskStatus.Done]: \"Done\"\n};\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./lib/constants.ts\n");
