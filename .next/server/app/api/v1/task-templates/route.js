...
(() => {
var exports = {};
exports.id = "app/api/v1/task-templates/route";
exports.ids = ["app/api/v1/task-templates/route"];
exports.modules = {

/***/ "(rsc)/./app/api/v1/task-templates/route.ts":
/*!********************************************!*\
  !*** ./app/api/v1/task-templates/route.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET),\n/* harmony export */   PUT: () => (/* binding */ PUT)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_middleware__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/middleware */ \"(rsc)/./lib/middleware.ts\");\n/* harmony import */ var _lib_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/lib/db */ \"(rsc)/./lib/db.ts\");\n\n\n\nasync function GET(request) {\n    return (0,_lib_middleware__WEBPACK_IMPORTED_MODULE_1__.withAuth)(request, async (req)=>{\n        const templates = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.taskTemplate.findMany({\n            where: {\n                userId: req.userId\n            }\n        });\n        const groupedBySubCategory = templates.reduce((acc, template)=>{\n            const key = template.subCategoryId;\n            if (!acc[key]) acc[key] = [];\n            acc[key].push({\n                id: template.id,\n                content: template.content\n            });\n            return acc;\n        }, {});\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(groupedBySubCategory);\n    });\n}\nasync function PUT(request) {\n    return (0,_lib_middleware__WEBPACK_IMPORTED_MODULE_1__.withAuth)(request, async (req)=>{\n        try {\n            const clientTemplates = await request.json();\n            // 중복 content 검사\n            const duplicateContents = [];\n            for(const subCatId in clientTemplates){\n                const contents = clientTemplates[subCatId].map((t)=>t.content);\n                const uniqueContents = new Set(contents);\n                if (contents.length !== uniqueContents.size) {\n                    const duplicates = contents.filter((content, index)=>contents.indexOf(content) !== index);\n                    duplicateContents.push(...duplicates);\n                }\n            }\n            if (duplicateContents.length > 0) {\n                return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                    message: 'DUPLICATE_CONTENT',\n                    duplicates: [\n                        ...new Set(duplicateContents)\n                    ]\n                }, {\n                    status: 400\n                });\n            }\n            await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.$transaction(async (tx)=>{\n                await tx.taskTemplate.deleteMany({\n                    where: {\n                        userId: req.userId\n                    }\n                });\n                const userSubCategoryIds = (await tx.subCategory.findMany({\n                    where: {\n                        category: {\n                            userId: req.userId\n                        }\n                    },\n                    select: {\n                        id: true\n                    }\n                })).map((sc)=>sc.id);\n                for(const subCatId in clientTemplates){\n                    if (userSubCategoryIds.includes(subCatId)) {\n                        for (const template of clientTemplates[subCatId]){\n                            await tx.taskTemplate.create({\n                                data: {\n                                    content: template.content,\n                                    subCategoryId: subCatId,\n                                    userId: req.userId\n                                }\n                            });\n                        }\n                    }\n                }\n            });\n            const newTemplates = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.taskTemplate.findMany({\n                where: {\n                    userId: req.userId\n                }\n            });\n            const grouped = newTemplates.reduce((acc, template)=>{\n                const key = template.subCategoryId;\n                if (!acc[key]) acc[key] = [];\n                acc[key].push({\n                    id: template.id,\n                    content: template.content\n                });\n                return acc;\n            }, {});\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(grouped);\n        } catch (error) {\n            console.error('Error updating task templates:', error);\n            // Prisma unique constraint 에러 처리\n            if (error.code === 'P2002') {\n                return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                    message: 'DUPLICATE_CONTENT',\n                    details: '동일한 내용의 태스크 템플릿이 이미 존재합니다.'\n                }, {\n                    status: 400\n                });\n            }\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                message: 'Failed to update task templates'\n            }, {\n                status: 500\n            });\n        }\n    });\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/v1/task-templates/route.ts\n");
