...
/***/ "(rsc)/./app/api/v1/events/route.ts":
/*!************************************!*\
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET),\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_middleware__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/middleware */ \"(rsc)/./lib/middleware.ts\");\n/* harmony import */ var _lib_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/lib/db */ \"(rsc)/./lib/db.ts\");\n\n\n\nasync function GET(request) {\n    return (0,_lib_middleware__WEBPACK_IMPORTED_MODULE_1__.withAuth)(request, async (req)=>{\n        const events = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.event.findMany({\n            where: {\n                userId: req.userId\n            },\n            orderBy: {\n                date: 'asc'\n            }\n        });\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(events.map((e)=>({\n                ...e,\n                date: e.date.toISOString().split('T')[0]\n            })));\n    });\n}\nasync function POST(request) {\n    return (0,_lib_middleware__WEBPACK_IMPORTED_MODULE_1__.withAuth)(request, async (req)=>{\n        try {\n            const { date, categoryId, subCategoryId, ...eventData } = await request.json();\n            const category = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.category.findFirst({\n                where: {\n                    id: categoryId,\n                    userId: req.userId\n                }\n            });\n            if (!category) {\n                return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                    message: 'Invalid category provided.'\n                }, {\n                    status: 400\n                });\n            }\n            if (subCategoryId) {\n                const subCategory = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.subCategory.findFirst({\n                    where: {\n                        id: subCategoryId,\n                        categoryId\n                    }\n                });\n                if (!subCategory) {\n                    return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                        message: 'Invalid sub-category provided.'\n                    }, {\n                        status: 400\n                    });\n                }\n            }\n            const newEvent = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.event.create({\n                data: {\n                    ...eventData,\n                    categoryId,\n                    subCategoryId,\n                    date: new Date(date),\n                    userId: req.userId\n                }\n            });\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                ...newEvent,\n                date: newEvent.date.toISOString().split('T')[0]\n            }, {\n                status: 201\n            });\n        } catch (error) {\n            console.error('Error creating event:', error);\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                message: 'Failed to create event'\n            }, {\n                status: 500\n            });\n        }\n    });\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/v1/events/route.ts\n");
